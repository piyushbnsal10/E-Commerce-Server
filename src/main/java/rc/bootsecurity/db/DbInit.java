...
public class DbInit {
  ...
  public void run(String... args) {
    ...
    Product p1 = new Product("Usha Ceiling Fan", "A High speed fan which will freeze you", "Electronics", 1500,
        "https://5.imimg.com/data5/UF/EM/MY-5431215/usha-anti-dust-ceiling-fan-500x500.jpg");

    Product p2 = new Product("Levis Trouser", "When you wear it, then you feel it", "Clothing", 2000,
        "https://rukminim1.flixcart.com/image/332/398/jtn9bww0/trouser/r/n/2/32-74712-0000-levi-s-original-imafeydc8uhgdkvg.jpeg");

    Product p3 = new Product("Realme X Smartphone", "But it once, you will remember it", "Electronics", 16000,
